...
static gboolean on_pattern_entry_keypressed (GtkWidget            *entry,
                             GdkEventKey          *event,
                             GnomeCmdSearchDialog *dialog)
{
...
static void on_list_file_clicked (GnomeCmdFileList *fl,
                      GnomeCmdFile *finfo,
...
static void on_dialog_size_allocate (GtkWidget       *widget,
