...
static void
search_dlg_init (GViewerSearchDlg *sdlg)
{
	GtkTable *table;
	GtkWidget *entry;
	...
	sdlg->priv->hex_mode = gtk_radio_button_new_with_mnemonic_from_widget(
				GTK_RADIO_BUTTON(sdlg->priv->text_mode),_("_Hex"));
...
GType
gviewer_search_dlg_get_type (void)
{
