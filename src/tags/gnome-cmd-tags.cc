...
void gcmd_tags_init()
{
    ...
    metatags_data[] = {
                       ...
                       {TAG_EXIF_FNUMBER, {"Exif.FNumber", TAG_EXIF, N_("F Number"), N_("The F number.")}},
                       ...
                       {TAG_EXIF_FOCALPLANEYRESOLUTION, {"Exif.FocalPlaneYResolution", TAG_EXIF, N_("Focal Plane y-Resolution"), N_("Indicates the number of pixels in the image height (V) direction per <Exif.FocalPlaneResolutionUnit> on the camera focal plane.")}},
                       ...
                       {TAG_IMAGE_CAMERAMAKE, {"Image.CameraMake", TAG_IMAGE, N_("Camera Make"), N_("Make of camera used to take the image.")}},
                       {TAG_IMAGE_CAMERAMODEL, {"Image.CameraModel", TAG_IMAGE, N_("Camera Model"), N_("Model of camera used to take the image.")}},
