...
void GnomeCmdSelectionProfileComponent::update()
{
    ...
    gtk_entry_set_text (GTK_ENTRY (gtk_combo_box_get_child (GTK_COMBO_BOX (priv->pattern_combo))), profile.filename_pattern.c_str());
    ...
    gtk_entry_set_text (GTK_ENTRY (gtk_combo_box_get_child (GTK_COMBO_BOX (priv->find_text_combo))), profile.text_pattern.c_str());
...
{
    const char *pattern_text = gtk_entry_get_text (GTK_ENTRY (gtk_combo_box_get_child (GTK_COMBO_BOX (priv->pattern_combo))));
    ...
    const char *find_text = gtk_entry_get_text (GTK_ENTRY (gtk_combo_box_get_child (GTK_COMBO_BOX (priv->find_text_combo))));
