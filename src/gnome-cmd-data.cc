...
void GnomeCmdData::load()
{
    ...
    gdk_key_names_data[] = {
                            {GDK_KEY_ampersand, "ampersand"},
                            {GDK_KEY_apostrophe, "apostrophe"},
                            {GDK_KEY_asciicircum, "asciicircum"},
                            {GDK_KEY_asciitilde, "asciitilde"},
                            {GDK_KEY_asterisk, "asterisk"},
                            {GDK_KEY_at, "at"},
                            {GDK_KEY_backslash, "backslash"},
                            {GDK_KEY_bar, "bar"},
                            {GDK_KEY_braceleft, "braceleft"},
                            {GDK_KEY_braceright, "braceright"},
                            {GDK_KEY_bracketleft, "bracketleft"},
                            {GDK_KEY_bracketright, "bracketright"},
                            {GDK_KEY_colon, "colon"},
                            {GDK_KEY_comma, "comma"},
                            {GDK_KEY_dollar, "dollar"},
                            {GDK_KEY_equal, "equal"},
                            {GDK_KEY_exclam, "exclam"},
                            {GDK_KEY_greater, "greater"},
                            {GDK_KEY_grave, "grave"},
                            {GDK_KEY_less, "less"},
                            {GDK_KEY_minus, "minus"},
                            {GDK_KEY_numbersign, "numbersign"},
                            {GDK_KEY_parenleft, "parenleft"},
                            {GDK_KEY_parenright, "parenright"},
                            {GDK_KEY_percent, "percent"},
                            {GDK_KEY_period, "period"},
                            {GDK_KEY_plus, "plus"},
                            {GDK_KEY_question, "question"},
                            {GDK_KEY_quotedbl, "quotedbl"},
                            {GDK_KEY_quoteleft, "quoteleft"},
                            {GDK_KEY_quoteright, "quoteright"},
                            {GDK_KEY_semicolon, "semicolon"},
                            {GDK_KEY_slash, "slash"},
                            {GDK_KEY_space, "space"},
                            {GDK_KEY_underscore, "underscore"},
                            ...
                            {GDK_KEY_KP_8, "kp.8"},
                            {GDK_KEY_KP_9, "kp.9"},
                            {GDK_KEY_KP_Add, "kp.add"},
                            {GDK_KEY_KP_Begin, "kp.begin"},
                            {GDK_KEY_KP_Decimal, "kp.decimal"},
                            {GDK_KEY_KP_Delete, "kp.delete"},
                            {GDK_KEY_KP_Divide, "kp.divide"},
                            {GDK_KEY_KP_Down, "kp.down"},
                            {GDK_KEY_KP_End, "kp.end"},
                            {GDK_KEY_KP_Enter, "kp.enter"},
                            {GDK_KEY_KP_Equal, "kp.equal"},
                            {GDK_KEY_KP_F1, "kp.f1"},
                            {GDK_KEY_KP_F2, "kp.f2"},
                            {GDK_KEY_KP_F3, "kp.f3"},
                            {GDK_KEY_KP_F4, "kp.f4"},
                            {GDK_KEY_KP_Home, "kp.home"},
                            {GDK_KEY_KP_Insert, "kp.insert"},
                            {GDK_KEY_KP_Left, "kp.left"},
                            {GDK_KEY_KP_Multiply, "kp.multiply"},
                            {GDK_KEY_KP_Next, "kp.next"},
                            {GDK_KEY_KP_Page_Down, "kp.page.down"},
                            {GDK_KEY_KP_Page_Up, "kp.page.up"},
                            {GDK_KEY_KP_Prior, "kp.prior"},
                            {GDK_KEY_KP_Right, "kp.right"},
                            {GDK_KEY_KP_Separator, "kp.separator"},
                            {GDK_KEY_KP_Space, "kp.space"},
                            {GDK_KEY_KP_Subtract, "kp.subtract"},
                            {GDK_KEY_KP_Tab, "kp.tab"},
                            {GDK_KEY_KP_Up, "kp.up"},

                            {GDK_KEY_Caps_Lock, "caps.lock"},
                            {GDK_KEY_Num_Lock, "num.lock"},
                            {GDK_KEY_Scroll_Lock, "scroll.lock"},
                            {GDK_KEY_Shift_Lock, "shift.lock"},
                            ...
                            {GDK_KEY_Clear, "clear"},
                            {GDK_KEY_Codeinput, "codeinput"},
                            {GDK_KEY_Delete, "delete"},
                            {GDK_KEY_Down, "down"},
                            {GDK_KEY_Eisu_Shift, "eisu.shift"},
                            {GDK_KEY_Eisu_toggle, "eisu.toggle"},
                            {GDK_KEY_End, "end"},
                            {GDK_KEY_Escape, "escape"},
                            {GDK_KEY_Execute, "execute"},
                            {GDK_KEY_Find, "find"},
                            {GDK_KEY_First_Virtual_Screen, "first.virtual.screen"},
                            {GDK_KEY_Help, "help"},
                            {GDK_KEY_Home, "home"},
                            {GDK_KEY_Hyper_L, "hyper.l"},
                            {GDK_KEY_Hyper_R, "hyper.r"},
                            {GDK_KEY_Insert, "insert"},
                            {GDK_KEY_Last_Virtual_Screen, "last.virtual.screen"},
                            {GDK_KEY_Left, "left"},
                            {GDK_KEY_Linefeed, "linefeed"},
                            {GDK_KEY_Menu, "menu"},
                            {GDK_KEY_Meta_L, "meta.l"},
                            {GDK_KEY_Meta_R, "meta.r"},
                            {GDK_KEY_Mode_switch, "mode.switch"},
                            {GDK_KEY_MultipleCandidate, "multiplecandidate"},
                            {GDK_KEY_Multi_key, "multi.key"},
                            {GDK_KEY_Next, "next"},
                            {GDK_KEY_Next_Virtual_Screen, "next.virtual.screen"},
                            {GDK_KEY_Page_Down, "page.down"},
                            {GDK_KEY_Page_Up, "page.up"},
                            {GDK_KEY_Pause, "pause"},
                            {GDK_KEY_PreviousCandidate, "previouscandidate"},
                            {GDK_KEY_Prev_Virtual_Screen, "prev.virtual.screen"},
                            {GDK_KEY_Print, "print"},
                            {GDK_KEY_Prior, "prior"},
                            {GDK_KEY_Redo, "redo"},
                            {GDK_KEY_Return, "return"},
                            {GDK_KEY_Right, "right"},
                            {GDK_KEY_script_switch, "script.switch"},
                            {GDK_KEY_Select, "select"},
                            {GDK_KEY_SingleCandidate, "singlecandidate"},
                            {GDK_KEY_Super_L, "super.l"},
                            {GDK_KEY_Super_R, "super.r"},
                            {GDK_KEY_Sys_Req, "sys.req"},
                            {GDK_KEY_Tab, "tab"},
                            {GDK_KEY_Terminate_Server, "terminate.server"},
                            {GDK_KEY_Undo, "undo"},
                            {GDK_KEY_Up, "up"}
                           };
