...
void gnome_cmd_data_load (void)
{
    ...
    gdk_key_names.add(GDK_ampersand, "ampersand");
    gdk_key_names.add(GDK_apostrophe, "apostrophe");
    gdk_key_names.add(GDK_asciicircum, "asciicircum");
    gdk_key_names.add(GDK_asciitilde, "asciitilde");
    gdk_key_names.add(GDK_asterisk, "asterisk");
    gdk_key_names.add(GDK_at, "at");
    gdk_key_names.add(GDK_backslash, "backslash");
    gdk_key_names.add(GDK_bar, "bar");
    gdk_key_names.add(GDK_braceleft, "braceleft");
    gdk_key_names.add(GDK_braceright, "braceright");
    gdk_key_names.add(GDK_bracketleft, "bracketleft");
    gdk_key_names.add(GDK_bracketright, "bracketright");
    gdk_key_names.add(GDK_colon, "colon");
    gdk_key_names.add(GDK_comma, "comma");
    gdk_key_names.add(GDK_dollar, "dollar");
    gdk_key_names.add(GDK_equal, "equal");
    gdk_key_names.add(GDK_exclam, "exclam");
    gdk_key_names.add(GDK_greater, "greater");
    gdk_key_names.add(GDK_less, "less");
    gdk_key_names.add(GDK_minus, "minus");
    gdk_key_names.add(GDK_numbersign, "numbersign");
    gdk_key_names.add(GDK_parenleft, "parenleft");
    gdk_key_names.add(GDK_parenright, "parenright");
    gdk_key_names.add(GDK_percent, "percent");
    gdk_key_names.add(GDK_period, "period");
    gdk_key_names.add(GDK_plus, "plus");
    gdk_key_names.add(GDK_question, "question");
    gdk_key_names.add(GDK_quotedbl, "quotedbl");
    gdk_key_names.add(GDK_quoteleft, "quoteleft");
    gdk_key_names.add(GDK_quoteright, "quoteright");
    gdk_key_names.add(GDK_semicolon, "semicolon");
    gdk_key_names.add(GDK_slash, "slash");
    gdk_key_names.add(GDK_space, "space");
    gdk_key_names.add(GDK_underscore, "underscore");

    gdk_key_names.add(GDK_F1, "f1");
    gdk_key_names.add(GDK_F2, "f2");
    gdk_key_names.add(GDK_F3, "f3");
    gdk_key_names.add(GDK_F4, "f4");
    gdk_key_names.add(GDK_F5, "f5");
    gdk_key_names.add(GDK_F6, "f6");
    gdk_key_names.add(GDK_F7, "f7");
    gdk_key_names.add(GDK_F8, "f8");
    gdk_key_names.add(GDK_F9, "f9");
    gdk_key_names.add(GDK_F10, "f10");
    gdk_key_names.add(GDK_F11, "f11");
    gdk_key_names.add(GDK_F12, "f12");
    gdk_key_names.add(GDK_F13, "f13");
    gdk_key_names.add(GDK_F14, "f14");
    gdk_key_names.add(GDK_F15, "f15");
    gdk_key_names.add(GDK_F16, "f16");
    gdk_key_names.add(GDK_F17, "f17");
    gdk_key_names.add(GDK_F18, "f18");
    gdk_key_names.add(GDK_F19, "f19");
    gdk_key_names.add(GDK_F20, "f20");
    gdk_key_names.add(GDK_F21, "f21");
    gdk_key_names.add(GDK_F22, "f22");
    gdk_key_names.add(GDK_F23, "f23");
    gdk_key_names.add(GDK_F24, "f24");
    gdk_key_names.add(GDK_F25, "f25");
    gdk_key_names.add(GDK_F26, "f26");
    gdk_key_names.add(GDK_F27, "f27");
    gdk_key_names.add(GDK_F28, "f28");
    gdk_key_names.add(GDK_F29, "f29");
    gdk_key_names.add(GDK_F30, "f30");
    gdk_key_names.add(GDK_F31, "f31");
    gdk_key_names.add(GDK_F32, "f32");
    gdk_key_names.add(GDK_F33, "f33");
    gdk_key_names.add(GDK_F34, "f34");
    gdk_key_names.add(GDK_F35, "f35");

    gdk_key_names.add(GDK_KP_0, "kp.0");
    gdk_key_names.add(GDK_KP_1, "kp.1");
    gdk_key_names.add(GDK_KP_2, "kp.2");
    gdk_key_names.add(GDK_KP_3, "kp.3");
    gdk_key_names.add(GDK_KP_4, "kp.4");
    gdk_key_names.add(GDK_KP_5, "kp.5");
    gdk_key_names.add(GDK_KP_6, "kp.6");
    gdk_key_names.add(GDK_KP_7, "kp.7");
    gdk_key_names.add(GDK_KP_8, "kp.8");
    gdk_key_names.add(GDK_KP_9, "kp.9");
    gdk_key_names.add(GDK_KP_Add, "kp.add");
    gdk_key_names.add(GDK_KP_Begin, "kp.begin");
    gdk_key_names.add(GDK_KP_Decimal, "kp.decimal");
    gdk_key_names.add(GDK_KP_Delete, "kp.delete");
    gdk_key_names.add(GDK_KP_Divide, "kp.divide");
    gdk_key_names.add(GDK_KP_Down, "kp.down");
    gdk_key_names.add(GDK_KP_End, "kp.end");
    gdk_key_names.add(GDK_KP_Enter, "kp.enter");
    gdk_key_names.add(GDK_KP_Equal, "kp.equal");
    gdk_key_names.add(GDK_KP_F1, "kp.f1");
    gdk_key_names.add(GDK_KP_F2, "kp.f2");
    gdk_key_names.add(GDK_KP_F3, "kp.f3");
    gdk_key_names.add(GDK_KP_F4, "kp.f4");
    gdk_key_names.add(GDK_KP_Home, "kp.home");
    gdk_key_names.add(GDK_KP_Insert, "kp.insert");
    gdk_key_names.add(GDK_KP_Left, "kp.left");
    gdk_key_names.add(GDK_KP_Multiply, "kp.multiply");
    gdk_key_names.add(GDK_KP_Next, "kp.next");
    gdk_key_names.add(GDK_KP_Page_Down, "kp.page.down");
    gdk_key_names.add(GDK_KP_Page_Up, "kp.page.up");
    gdk_key_names.add(GDK_KP_Prior, "kp.prior");
    gdk_key_names.add(GDK_KP_Right, "kp.right");
    gdk_key_names.add(GDK_KP_Separator, "kp.separator");
    gdk_key_names.add(GDK_KP_Space, "kp.space");
    gdk_key_names.add(GDK_KP_Subtract, "kp.subtract");
    gdk_key_names.add(GDK_KP_Tab, "kp.tab");
    gdk_key_names.add(GDK_KP_Up, "kp.up");

    gdk_key_names.add(GDK_Caps_Lock, "caps.lock");
    gdk_key_names.add(GDK_Num_Lock, "num.lock");
    gdk_key_names.add(GDK_Scroll_Lock, "scroll.lock");
    gdk_key_names.add(GDK_Shift_Lock, "shift.lock");

    gdk_key_names.add(GDK_BackSpace, "backspace");
    gdk_key_names.add(GDK_Begin, "begin");
    gdk_key_names.add(GDK_Break, "break");
    gdk_key_names.add(GDK_Cancel, "cancel");
    gdk_key_names.add(GDK_Clear, "clear");
    gdk_key_names.add(GDK_Codeinput, "codeinput");
    gdk_key_names.add(GDK_Delete, "delete");
    gdk_key_names.add(GDK_Down, "down");
    gdk_key_names.add(GDK_Eisu_Shift, "eisu.shift");
    gdk_key_names.add(GDK_Eisu_toggle, "eisu.toggle");
    gdk_key_names.add(GDK_End, "end");
    gdk_key_names.add(GDK_Escape, "escape");
    gdk_key_names.add(GDK_Execute, "execute");
    gdk_key_names.add(GDK_Find, "find");
    gdk_key_names.add(GDK_First_Virtual_Screen, "first.virtual.screen");
    gdk_key_names.add(GDK_Help, "help");
    gdk_key_names.add(GDK_Home, "home");
    gdk_key_names.add(GDK_Hyper_L, "hyper.l");
    gdk_key_names.add(GDK_Hyper_R, "hyper.r");
    gdk_key_names.add(GDK_Insert, "insert");
    gdk_key_names.add(GDK_Last_Virtual_Screen, "last.virtual.screen");
    gdk_key_names.add(GDK_Left, "left");
    gdk_key_names.add(GDK_Linefeed, "linefeed");
    gdk_key_names.add(GDK_Menu, "menu");
    gdk_key_names.add(GDK_Meta_L, "meta.l");
    gdk_key_names.add(GDK_Meta_R, "meta.r");
    gdk_key_names.add(GDK_Mode_switch, "mode.switch");
    gdk_key_names.add(GDK_MultipleCandidate, "multiplecandidate");
    gdk_key_names.add(GDK_Multi_key, "multi.key");
    gdk_key_names.add(GDK_Next, "next");
    gdk_key_names.add(GDK_Next_Virtual_Screen, "next.virtual.screen");
    gdk_key_names.add(GDK_Page_Down, "page.down");
    gdk_key_names.add(GDK_Page_Up, "page.up");
    gdk_key_names.add(GDK_Pause, "pause");
    gdk_key_names.add(GDK_PreviousCandidate, "previouscandidate");
    gdk_key_names.add(GDK_Prev_Virtual_Screen, "prev.virtual.screen");
    gdk_key_names.add(GDK_Print, "print");
    gdk_key_names.add(GDK_Prior, "prior");
    gdk_key_names.add(GDK_Redo, "redo");
    gdk_key_names.add(GDK_Return, "return");
    gdk_key_names.add(GDK_Right, "right");
    gdk_key_names.add(GDK_script_switch, "script.switch");
    gdk_key_names.add(GDK_Select, "select");
    gdk_key_names.add(GDK_SingleCandidate, "singlecandidate");
    gdk_key_names.add(GDK_Super_L, "super.l");
    gdk_key_names.add(GDK_Super_R, "super.r");
    gdk_key_names.add(GDK_Sys_Req, "sys.req");
    gdk_key_names.add(GDK_Tab, "tab");
    gdk_key_names.add(GDK_Terminate_Server, "terminate.server");
    gdk_key_names.add(GDK_Undo, "undo");
    gdk_key_names.add(GDK_Up, "up");
}
