...
extern "C" GVInputModesData *gv_input_modes_new();
...
*/
extern "C" const char *gv_get_input_mode(GVInputModesData *imd);
...
*/
extern "C" void gv_set_input_mode(GVInputModesData *imd, const gchar *input_mode);
...
*/
extern "C" char_type gv_input_mode_get_utf8_char(GVInputModesData *imd, offset_type offset);
...
extern "C" char_type gv_input_mode_byte_to_utf8(GVInputModesData *imd, unsigned char data);
...
*/
extern "C" void gv_input_mode_update_utf8_translation(GVInputModesData *imd, unsigned char index, char_type new_value);
...
*/
extern "C" int gv_input_mode_get_raw_byte(GVInputModesData *imd, offset_type offset);
...
*/
extern "C" offset_type gv_input_get_next_char_offset(GVInputModesData *imd, offset_type current_offset);

/*
    returns the BYTE offset of the previous logical character.

*/
extern "C" offset_type gv_input_get_previous_char_offset(GVInputModesData *imd, offset_type current_offset);
