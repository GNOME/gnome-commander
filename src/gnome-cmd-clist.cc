...
#pragma GCC diagnostic ignored "-Wswitch-enum"
        ...
        switch (clist_row->cell[i].type)
        {
            case GTK_CELL_PIXMAP:
                gdk_pixmap_get_size (GTK_CELL_PIXMAP (clist_row->cell[i])->pixmap, &pixmap_width, &height);
                width += pixmap_width;
                break;

            case GTK_CELL_PIXTEXT:
                gdk_pixmap_get_size (GTK_CELL_PIXTEXT (clist_row->cell[i])->pixmap, &pixmap_width, &height);
